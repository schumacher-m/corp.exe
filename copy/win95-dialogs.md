  ...
  "confirms": [
    {
      ...
      "buttons": ["Clock Out", "One More Ticket"]
    },
    {
      "title": "Save Changes",
      "body": "Save changes to Untitled Sprint? (There are no changes. Save anyway.)",
      "buttons": ["Save", "Don't Save", "Cancel Career"]
    }
  ]
}
```
