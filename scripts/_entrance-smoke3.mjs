...
await page.goto("http://127.0.0.1:8765/?v=tower3c", { waitUntil: "domcontentloaded", timeout: 60000 });
...
const land = await page.evaluate(() => document.getElementById("hud-prompt")?.textContent || "");
...
console.log(JSON.stringify({ land, near, lobby }, null, 2));
await browser.close();
